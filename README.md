...
Welcome to the **below-the-14th** repository! This repository was generated from a template to get you started quickly.
...
1. Clone the repository:
   ```bash
   git clone https://github.com/Vianpyro/below-the-14th.git
   cd below-the-14th
   ```
